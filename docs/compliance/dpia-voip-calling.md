...
> Companion documents:
> [`../threat-models/voip-calling.md`](../security/threat-models/voip-calling.md)
> (call/signaling threat model — source of truth),
> [`../threat-models/voip-turn.md`](../security/threat-models/voip-turn.md) (relay
...
| **First public ingress** widens attack surface | Medium / High | Three narrow NSG allows; coturn non-root/read-only/caps-dropped/crypto-blind; HTTP origin stays tunnel-only | **Reduced**; see [`voip-turn.md`](../security/threat-models/voip-turn.md) |
...
[`voip-calling.md`](../security/threat-models/voip-calling.md) §10 (authenticated-sender
