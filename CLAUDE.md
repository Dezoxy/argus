...
The canonical engineering contract is **AGENTS.md** (imported above) — shared
with Codex and every other agent. This section adds only the
...
Keep all *rules* in AGENTS.md so Codex and Claude never drift. Only
Claude-specific wiring belongs here.
